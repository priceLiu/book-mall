  ...
  return (
    <div className="mx-auto flex w-full max-w-sm flex-col gap-5">
      <div className="flex items-center gap-2">
        ...
        <span className="text-xl font-semibold">QuickReplica</span>
      </div>
      <div>
      ...
      <form onSubmit={onSubmit} className="flex flex-col gap-3">
        ...
        {tab === "password" ? (
          ...
          <div className="flex gap-2">
            ...
            <button
              type="button"
              className="qr-btn-secondary whitespace-nowrap"
        ...
        {hint ? (
          <p className="text-xs text-[var(--qr-text-secondary)]">{hint}</p>
        ) : null}
        {error ? (
      ...
      <p className="text-center text-sm text-[var(--qr-text-secondary)]">
        还没有账号？{" "}
        <a href={`/register?redirect=${encodeURIComponent(redirect)}`} className="font-medium text-[var(--qr-brand)] hover:underline">
          注册
        </a>
      </p>
    </div>
