...
export default defineConfig({
  ...
  test: {
    include: [
      ...
      "test/unit/pro2-hub-media-group-edge.test.ts",
      ...
      "test/unit/pro2-video-board-group-removal.test.ts",
      ...
      "test/unit/pro2-wizard-asset-image-run.test.ts",
      ...
      "test/unit/pro2-wizard-shot-prompt-persist.test.ts",
      "test/unit/pro2-wizard-shot-draft.test.ts",
      "test/unit/pro2-wizard-shot-media-run.test.ts",
      "test/unit/pro2-production-script-flow.test.ts",
      "test/unit/pro2-production-script-origin.test.ts",
      ...
      "test/unit/pro2-character-board-column-placeholder.test.ts",
      "test/unit/pro2-character-script-fields.test.ts",
      "test/unit/pro2-project-format.test.ts",
      ...
      "test/unit/libtv-tag-plain-edit.test.ts",
      "test/unit/tag-rich-text-migrate.test.ts",
      "test/unit/pro2-tag-node-label.test.ts",
