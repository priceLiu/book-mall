...
export default defineConfig({
  ...
  test: {
    include: [
      ...
      "test/unit/storyboard-parse.test.ts",
      ...
      "test/unit/canvas-viewport-zoom.test.ts",
      ...
      "test/unit/canvas-save-phase.test.ts",
      "test/unit/canvas-network-status.test.ts",
      ...
      "test/unit/tools-jwt-exp.test.ts",
