...
/** sbv1 图片 · 空态默认 16:9（与 Dock 参数面板一致） */
export const SBV1_IMAGE_NODE_16_9_WIDTH = LIBTV_MEDIA_STAGE_LANDSCAPE_WIDTH;
export const SBV1_IMAGE_NODE_16_9_HEIGHT =
  SBV1_MEDIA_CARD_HEADER_HEIGHT + LIBTV_MEDIA_STAGE_LANDSCAPE_16_9_HEIGHT;
/** @deprecated 旧 4:3 空态；新节点请用 SBV1_IMAGE_NODE_16_9_* */
