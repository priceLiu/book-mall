...
/** 磨砂预览钮（尺寸由 resolveCanvasMediaPreviewChrome 写入 style） */
export const CANVAS_MEDIA_PREVIEW_BTN_CLASS =
  "nodrag pointer-events-auto inline-flex shrink-0 items-center justify-center rounded-full border border-white/40 bg-white/25 text-[#1d1d1f] shadow-lg ring-1 ring-black/[0.06] backdrop-blur-md transition hover:bg-white/35 hover:scale-[1.03]";
