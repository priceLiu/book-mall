...
> = {
  ...
  reconciliation: { label: "对账差异", docSection: "TC-A5～A10 / TC-B5" },
...
const FILE = {
  ...
  aliyunReconAdapter: "test/unit/aliyun-reconciliation-adapter.test.ts",
  reconciliationV2Engine: "test/unit/reconciliation-v2-engine.test.ts",
...
export const FINANCE_VITEST_CATALOG: FinanceTestCase[] = [
  ...
  unit(
    "aliyun-csv-wan-image",
    "TC-A6",
    "reconciliation",
    "aliyun consumedetail v2 adapter",
    "parses wan2.7-image 93 imgs @ ¥0.2",
    FILE.aliyunReconAdapter,
  ),
  unit(
    "aliyun-csv-hh-1080",
    "TC-A6",
    "reconciliation",
    "aliyun consumedetail v2 adapter",
    "parses HappyHorse 1080P 153s",
    FILE.aliyunReconAdapter,
  ),
  unit(
    "aliyun-csv-token-split",
    "TC-A6",
    "reconciliation",
    "aliyun consumedetail v2 adapter",
    "splits qwen3.5-flash input/output tokens",
    FILE.aliyunReconAdapter,
  ),
  unit(
    "aliyun-csv-skip-free",
    "TC-A6",
    "reconciliation",
    "aliyun consumedetail v2 adapter",
    "skips free quota rows with zero usage",
    FILE.aliyunReconAdapter,
  ),
  unit(
    "recon-v2-ok",
    "TC-A7",
    "reconciliation",
    "reconciliation v2 engine",
    "marks matching usage as OK",
    FILE.reconciliationV2Engine,
  ),
  unit(
    "recon-v2-asr-under",
    "TC-A7",
    "reconciliation",
    "reconciliation v2 engine",
    "marks UNDER when platform has less ASR seconds",
    FILE.reconciliationV2Engine,
  ),
  unit(
    "recon-v2-missing-vendor",
    "TC-A7",
    "reconciliation",
    "reconciliation v2 engine",
    "marks MISSING_VENDOR when platform only",
    FILE.reconciliationV2Engine,
  ),
  // scenario-lab (2)
  unit(
