/**
 * 百炼 Qwen3-TTS-Flash 系统音色（非实时）
 * @see https://help.aliyun.com/zh/model-studio/qwen-tts-voice-list
 */
...
/** 与上游 qwen3-tts-flash 非实时接口一致；Gateway 路由 modelKey=qwen3-tts → qwen3-tts-flash */
