 ...
 *
 * 超额扣分测算口径（锚定 ¥0.03/积分）：
 * - 文生图 20 积分/次 ≈ ¥0.60 — 含试衣/解析；调度+存储+出网，平台侧毛利 ≥60%
 * - 图生视频 80 积分/次 ≈ ¥2.40 — 15s 任务编排、预览缓存、队列（不含厂商费）
 * - 视频生视频 100 积分/次 ≈ ¥3.00 — 较图生视频多一轮素材读写与转码
 * - 视频理解 15 积分/次 ≈ ¥0.45 — VL 视频附件 IO + 编排
 * - TTS 12 积分/次 ≈ ¥0.36 — 同步音频落 OSS
 */
