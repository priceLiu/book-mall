...
> = {
  ...
  "MiniMax/MiniMax-H3-t2v": {
    id: "MiniMax/MiniMax-H3-t2v",
    label: "MiniMax H3 · 文生视频",
    description: "MiniMax H3 · 文本提示词生成视频。",
    requiresImage: false,
    resolutions: ["768P", "2K"] as const,
    defaults: { resolution: "2K", duration: 5 },
    durationRange: [4, 15] as const,
    supports: { generateAudio: false, promptExtend: false, watermark: true },
  },
  "MiniMax/MiniMax-H3-i2v": {
    id: "MiniMax/MiniMax-H3-i2v",
    label: "MiniMax H3 · 图生视频",
    description: "MiniMax H3 · 首帧图 + 文本生成视频。",
    requiresImage: true,
    resolutions: ["768P", "2K"] as const,
    defaults: { resolution: "2K", duration: 5 },
    durationRange: [4, 15] as const,
  ...
  "MiniMax/MiniMax-H3-fl2v": {
    id: "MiniMax/MiniMax-H3-fl2v",
    label: "MiniMax H3 · 首尾帧",
    description: "MiniMax H3 · 首帧 + 尾帧生成过渡视频。",
    requiresImage: true,
    resolutions: ["768P", "2K"] as const,
    defaults: { resolution: "2K", duration: 5 },
    durationRange: [4, 15] as const,
  ...
  "MiniMax/MiniMax-H3-r2v": {
    id: "MiniMax/MiniMax-H3-r2v",
    label: "MiniMax H3 · 多模态参考",
    description: "MiniMax H3 · 参考图/视频/音频 + 文本生成视频。",
    requiresImage: true,
    resolutions: ["768P", "2K"] as const,
    defaults: { resolution: "2K", duration: 5 },
    durationRange: [4, 15] as const,
  ...
  "MiniMax/MiniMax-H3-s2v": {
    id: "MiniMax/MiniMax-H3-s2v",
    label: "MiniMax H3 · 主体参考",
    description: "MiniMax H3 · 人物主体参考图 + 文本生成视频。",
    requiresImage: true,
    resolutions: ["768P", "2K"] as const,
    defaults: { resolution: "2K", duration: 5 },
    durationRange: [4, 15] as const,
  ...
  "MiniMax/MiniMax-H3-regeneration": {
    id: "MiniMax/MiniMax-H3-regeneration",
    label: "MiniMax H3 · 再生成",
    description: "MiniMax H3 · 将 768P 成片再生成 2K。",
    requiresImage: false,
    resolutions: ["2K"] as const,
    defaults: { resolution: "2K", duration: 5 },
    durationRange: [4, 15] as const,
    supports: { generateAudio: false, promptExtend: false, watermark: true },
  },
  "MiniMax/MiniMax-H3-context-ir": {
    id: "MiniMax/MiniMax-H3-context-ir",
    label: "MiniMax H3 · Context IR",
    description: "MiniMax H3 · 多模态上下文理解，输出增强视频提示词。",
    requiresImage: false,
    resolutions: ["2K"] as const,
    defaults: { resolution: "2K", duration: 5 },
    durationRange: [4, 15] as const,
    supports: { generateAudio: false, promptExtend: true, watermark: false },
  },
};
