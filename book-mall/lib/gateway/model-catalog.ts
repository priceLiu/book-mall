...
const DASHSCOPE_LAB_VIDEO: Array<{
...
}> = [
  {
    ...
    description: "Image-to-video · tool lab",
    requestKind: "VIDEO",
    products: ["工具站"],
  },
  {
  ...
  },
  {
    ...
    displayName: "Wan 2.7 I2V (2026-04-25)",
  ...
  },
  {
    ...
    description: "Text-to-video · tool lab",
    requestKind: "VIDEO",
    products: ["工具站"],
  },
  {
  ...
  },
  {
    ...
    displayName: "Wan 2.7 T2V (2026-04-25)",
  ...
  },
  {
    ...
    description: "Reference-to-video · tool lab (Canvas Bailian R2V)",
    requestKind: "VIDEO",
    products: ["工具站"],
  },
  {
    modelKey: "happyhorse-1.1-r2v",
    displayName: "HappyHorse-1.1-R2V (DashScope)",
    description: "Reference-to-video · tool lab (Canvas Bailian R2V)",
    requestKind: "VIDEO",
    products: ["工具站"],
  },
  {
    modelKey: "wan2.7-r2v",
    displayName: "Wan 2.7 R2V (DashScope)",
