...
export function gatewayRouteDisplayName(
  ...
  const labels: Record<string, string> = {
    "gpt-image-2": "GPT Image 2 (KIE) · 文/图生图",
    "google/nano-banana": "NanoBanana Gemini 2.5 Flash · 文生图",
    "google/nano-banana-edit": "NanoBanana Gemini 2.5 Flash · 图生图",
    "4o-image": "4o Image · 文/图生图",
    "bytedance/seedance-2": "Seedance 2.0 (KIE)",
    "bytedance/seedance-2-mini": "Seedance 2.0 Mini (KIE)",
    veo3: "Veo 3",
    "veo3.1": "Veo 3.1",
    "hailuo/2-3-image-to-video-standard": "海螺 2.3 图生视频 · Standard",
    "hailuo/2-3-image-to-video-pro": "海螺 2.3 图生视频 · Pro",
    "kling/v2-5-turbo-image-to-video-pro": "可灵 2.5 Turbo · 图生视频",
    "kling/v2-5-turbo-text-to-video-pro": "可灵 2.5 Turbo · 文生视频",
