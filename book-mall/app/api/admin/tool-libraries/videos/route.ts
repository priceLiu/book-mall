...
export async function GET() {
  ...
  try {
    ...
    console.error("[admin/tool-libraries/videos] GET", e);
...
export async function DELETE(req: Request) {
  ...
  try {
    const row = await prisma.imageToVideoLibraryItem.findUnique({
      where: { id },
    ...
    console.error("[admin/tool-libraries/videos] DELETE", e);
