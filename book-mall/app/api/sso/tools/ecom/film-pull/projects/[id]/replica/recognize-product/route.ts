...
import { recognizeFilmPullReplicaProduct } from "@/lib/ecom/ecom-film-pull-replica";
...
export async function POST(req: Request, ctx: Ctx) {
  ...
  try {
    ...
    const result = await recognizeFilmPullReplicaProduct(auth.userId, id, { userDraft });
