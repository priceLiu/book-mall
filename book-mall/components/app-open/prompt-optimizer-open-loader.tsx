...
/** 提示词优化器过渡页动效 */
export function PromptOptimizerOpenLoader() {
  return (
    <div className="relative mx-auto flex flex-col items-center gap-7 py-2">
      <div
        className="pointer-events-none absolute left-1/2 top-1/2 h-[min(20rem,80vw)] w-[min(20rem,80vw)] -translate-x-1/2 -translate-y-1/2 rounded-full bg-indigo-500/[0.12] blur-[48px] motion-reduce:hidden"
        aria-hidden
      />
      <div
