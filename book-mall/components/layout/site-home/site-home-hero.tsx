...
function SiteHomeVideo() {
  ...
  return (
    <div className="site-home-hero-visual-media">
      <div
        className={cn(
      ...
      {videoError ? (
        <div className="site-home-hero-video-fallback">
        ...
        <Image
          ...
          className="site-home-hero-video-el"
          src={HERO_POSTER}
          alt="智选 AI Mall 主视觉"
        />
      ) : (
        <>
          ...
          <button
            type="button"
            className="site-home-hero-fullscreen"
