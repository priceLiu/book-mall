...
import { HeroSparklesHeadline } from "@/components/layout/sections/hero-sparkles-headline";
...
export const HeroSection = () => {
  ...
  return (
    <section id="hero-video" className="container w-full scroll-mt-28">
      <div className="grid place-items-center lg:max-w-screen-xl gap-4 mx-auto py-20 md:py-28">
        <div className="text-center space-y-6">
          <HeroSparklesHeadline />
        ...
        <div className={cn("relative group mt-4 md:mt-6", siteHeaderWidthClass)}>
          ...
          >
            ...
            {videoError ? (
              ...
              <Image
                width={POSTER_DIM.w}
                height={POSTER_DIM.h}
                sizes="(max-width: 768px) 90vw, (max-width: 1024px) 70vw, 75vw"
                priority
                placeholder="blur"
