...
export function HeroPreviewFrameworks() {
  return (
    <div className="home-preview-frameworks-wrapper" aria-hidden>
      <div className="home-preview-frameworks">
        <ReactLogo />
        <WebpackLogo />
        <ViteLogo />
        <RspackLogo />
...
function ReactLogo() {
  return (
    <span className="home-preview-fw-item home-preview-fw-react">
...
function WebpackLogo() {
  return (
    <span className="home-preview-fw-item home-preview-fw-webpack">
...
function ViteLogo() {
  return (
    <span className="home-preview-fw-item home-preview-fw-vite">
...
function RspackLogo() {
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="home-preview-fw-item home-preview-fw-rspack"
    >
...
function RemixLogo() {
  return (
    <span className="home-preview-fw-item home-preview-fw-remix">
...
function NextLogo() {
  return (
    <span className="home-preview-fw-item home-preview-fw-next">
