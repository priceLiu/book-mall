# 2 7 Text To Video API Documentation

> Generate content using the 2 7 Text To Video model

## Overview

This document describes how to use the 2 7 Text To Video model for content generation. The process consists of two steps:
...
|-----------|------|----------|-------------|
| model | string | Yes | Model name, format: `wan/2-7-text-to-video` |
...
|----------|-------|-------------|
| **Format** | `wan/2-7-text-to-video` | The exact model identifier for this API |
...
- **Type**: `string`
- **Required**: No
- **Description**: The ratio of output
- **Options**:
  - `16:9`: 16:9
  - `9:16`: 9:16
  - `1:1`: 1:1
...
```json
{
  ...
  "data": {
    ...
    "model": "wan/2-7-text-to-video",
    "state": "waiting",
    "param": "{\"model\":\"wan/2-7-text-to-video\",\"input\":{\"prompt\":\"A flower blooming and wilting over two weeks, one photo per day. Same vase, same window, same angle. Light changes with weather. Audio: Quiet domestic.\",\"negative_prompt\":\"Enter your prompt here...\",\"audio_url\":\"\",\"resolution\":\"1080p\",\"ratio\":\"16:9\",\"duration\":5,\"prompt_extend\":true,\"watermark\":false,\"seed\":42,\"nsfw_checker\":true}}",
    "resultJson": "{\"resultUrls\":[\"https://static.aiquickdraw.com/tools/example/1775568062605_MPXfAL3r.mp4\"]}",
    "failCode": null,
    "failMsg": null,
    "costTime": null,
    "completeTime": null,
