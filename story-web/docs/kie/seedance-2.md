...
> Generate content using the Seedance 2 model

## Overview

This document describes how to use the Seedance 2 model for content generation. The process consists of two steps:
...
|-----------|------|----------|-------------|
| model | string | Yes | Model name, format: `bytedance/seedance-2` |
...
- **Multiple Files**: Yes
- **Default Value**: `["https://static.aiquickdraw.com/tools/example/1775188169588_bgwi3VY9.png","https://static.aiquickdraw.com/tools/example/1775188179836_GjU1qcVv.png","https://static.aiquickdraw.com/tools/example/1775188213576_znqR80kS.png","https://static.aiquickdraw.com/tools/example/1775188231228_ddIfzCwT.png","https://static.aiquickdraw.com/tools/example/1775188250101_sZNRBuHh.png"]`
...
- **Multiple Files**: Yes
- **Default Value**: `["https://static.aiquickdraw.com/tools/example/1775200730595_9fXLmiHd.mp4"]`
...
```json
{
  ...
  "input": {
    ...
    "reference_image_urls": ["https://static.aiquickdraw.com/tools/example/1775188169588_bgwi3VY9.png","https://static.aiquickdraw.com/tools/example/1775188179836_GjU1qcVv.png","https://static.aiquickdraw.com/tools/example/1775188213576_znqR80kS.png","https://static.aiquickdraw.com/tools/example/1775188231228_ddIfzCwT.png","https://static.aiquickdraw.com/tools/example/1775188250101_sZNRBuHh.png"],
    "reference_video_urls": ["https://static.aiquickdraw.com/tools/example/1775200730595_9fXLmiHd.mp4"],
    "reference_audio_urls": [""],
    "generate_audio": true,
    "resolution": "720p",
    "aspect_ratio": "16:9",
...
```json
{
  ...
  "data": {
    ...
    "model": "bytedance/seedance-2",
    "state": "waiting",
    "param": "{\"model\":\"bytedance/seedance-2\",\"input\":{\"prompt\":\"Reference @Image1 @Image2 for the spear-wielding character, @Image3 @Image4 for the scene. Generate a martial arts action sequence where the character performs fluid spear techniques. Use multi-angle tracking shots to capture the power and beauty of martial arts.\",\"reference_image_urls\":[\"https://static.aiquickdraw.com/tools/example/1775188169588_bgwi3VY9.png\",\"https://static.aiquickdraw.com/tools/example/1775188179836_GjU1qcVv.png\",\"https://static.aiquickdraw.com/tools/example/1775188213576_znqR80kS.png\",\"https://static.aiquickdraw.com/tools/example/1775188231228_ddIfzCwT.png\",\"https://static.aiquickdraw.com/tools/example/1775188250101_sZNRBuHh.png\"],\"reference_video_urls\":[\"https://static.aiquickdraw.com/tools/example/1775200730595_9fXLmiHd.mp4\"],\"reference_audio_urls\":[\"\"],\"generate_audio\":true,\"resolution\":\"720p\",\"aspect_ratio\":\"16:9\",\"duration\":15,\"web_search\":false,\"nsfw_checker\":true}}",
    "resultJson": "{\"resultUrls\":[\"https://static.aiquickdraw.com/tools/example/1775188128418_vnfwuDsj.mp4\"]}",
    "failCode": null,
    "failMsg": null,
    "costTime": null,
    "completeTime": null,
