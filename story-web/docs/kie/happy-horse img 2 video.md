...
|-----------|------|----------|-------------|
| model | string | Yes | Model name, format: `happyhorse/image-to-video` |
...
|----------|-------|-------------|
| **Format** | `happyhorse/image-to-video` | The exact model identifier for this API |
...
- **Default Value**: `"Tracking shot as the girl walks gracefully through the meadow. Her dress and hair flutter in the wind, and clouds drift slowly. Cinematic audio of soft footsteps on grass, rustling summer wind, and melodic bird calls."`

#### image_urls
- **Type**: `array`
- **Required**: Yes
- **Description**: Please provide the URL of the uploaded file,First-frame image URL list. Exactly one image is required. Minimum resolution: width and height ≥ 300px. Aspect ratio: 1:2.5 to 2.5:1.
- **Max File Size**: 10MB
- **Accepted File Types**: image/jpeg, image/png, image/webp, image/jpg
- **Multiple Files**: Yes
- **Default Value**: `["https://static.aiquickdraw.com/tools/example/1777359961666_Z3je05MP.png"]`
...
```json
{
  ...
  "input": {
    "prompt": "Tracking shot as the girl walks gracefully through the meadow. Her dress and hair flutter in the wind, and clouds drift slowly. Cinematic audio of soft footsteps on grass, rustling summer wind, and melodic bird calls.",
    "image_urls": ["https://static.aiquickdraw.com/tools/example/1777359961666_Z3je05MP.png"],
    "resolution": "1080p",
    "duration": 5,
    "seed": 42
  }
...
```json
{
  ...
  "data": {
    ...
    "model": "happyhorse/image-to-video",
    "state": "waiting",
    "param": "{\"model\":\"happyhorse/image-to-video\",\"input\":{\"prompt\":\"Tracking shot as the girl walks gracefully through the meadow. Her dress and hair flutter in the wind, and clouds drift slowly. Cinematic audio of soft footsteps on grass, rustling summer wind, and melodic bird calls.\",\"image_urls\":[\"https://static.aiquickdraw.com/tools/example/1777359961666_Z3je05MP.png\"],\"resolution\":\"1080p\",\"duration\":5,\"seed\":42}}",
    "resultJson": "{\"resultUrls\":[\"https://static.aiquickdraw.com/tools/example/1777359980756_qYtjXyca.mp4\"]}",
    "failCode": null,
    "failMsg": null,
    "costTime": null,
    "completeTime": null,
