...
import { getHostOrigin, initDirectorDeskHostBridge } from "./editor/io/hostBridge";
...
export default function App() {
  ...
  useEffect(() => {
    ...
    window.parent?.postMessage({ type: "storyai:director-desk-ready" }, getHostOrigin());
  }, []);

  function handleClose() {
    window.parent?.postMessage({ type: "storyai:director-desk-close" }, getHostOrigin());
  }
