 ...
 *   - 调用 `/api/admin/finance/billing-detail-lines-all` 拉全部用户；
 *   - 顶部「本页位置 / 当前账单归属 / 数据来源」三块按图示要求隐藏；
 *   - 头部统计中「钱包余额 / 余额减扣点」两列折叠（无单一目标用户概念），改显「DB 总条数」。
 */
    ...
    <div className="flex h-full flex-col overflow-hidden">
      <header className="border-b border-[#e8e8e8] bg-white px-6 py-4">
        ...
        <p className="mt-1 text-xs text-[#8c8c8c]">
          数据来自 book-mall{" "}
          <code className="rounded bg-[#f5f5f5] px-1">/api/admin/finance/billing-detail-lines-all</code>
