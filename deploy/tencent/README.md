...
本仓库已带好 **`book-mall/Dockerfile`**、**`tool-web/Dockerfile`**、**`finance-web/Dockerfile`**、**`story-web/Dockerfile`**、**`canvas-web/Dockerfile`**、**`gateway-web/Dockerfile`**、**`prompt-optimizer-platform/Dockerfile`**、**`e-commerce-toolkit/Dockerfile`**、**`quick-replica-web/Dockerfile`**、**`director-web/Dockerfile`**（Next.js `standalone` 镜像；prompt 与 director 含上游 vendor 多阶段构建）。  
...
| **目标目录** | `book-mall` | `tool-web` | `finance-web` | `story-web` | `canvas-web` | `gateway-web` | **`prompt-optimizer-platform`** | **`e-commerce-toolkit`** | **`quick-replica-web`** | **`director-web`** |
| **Dockerfile** | 默认 | 同上 | 同上 | 同上 | 同上 | 同上 | 同上 | 同上 | 同上 | 同上 |
| **容器监听端口** | **3000** | **3001** | **3002** | **3003** | **3004** | **3005** | **3006** | **3007** | **3008** | **3009** |
| **自定义域（示例）** | `book.ai-code8.com` | `tool.ai-code8.com` | `f.ai-code8.com` | `story.ai-code8.com` | `canvas.ai-code8.com` | `gateway.ai-code8.com` | **`prompt.ai-code8.com`** | **`ecom.ai-code8.com`** | **`replica.ai-code8.com`** | **`director.ai-code8.com`** |
