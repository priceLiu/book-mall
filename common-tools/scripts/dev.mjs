...
if (!merged.COMMON_TOOLS_PUBLIC_ORIGIN?.trim()) {
  merged.COMMON_TOOLS_PUBLIC_ORIGIN = "http://localhost:3010";
}
if (!merged.NEXT_PUBLIC_COMMON_TOOLS_ORIGIN?.trim()) {
  merged.NEXT_PUBLIC_COMMON_TOOLS_ORIGIN = merged.COMMON_TOOLS_PUBLIC_ORIGIN;
}
...
if (secret.length < 16) {
  console.warn(
    "\n[common-tools] 警告: TOOLS_SSO_SERVER_SECRET 未配置或过短。\n" +
